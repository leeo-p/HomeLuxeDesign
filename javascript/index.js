...
cardHolder.addEventListener("keyup", (e) => {
    if (!e.target.value) {
        cardHolderText.innerHTML = "WEB MASTER";
    } else {
...
form.addEventListener("submit", (e) => {
    ...
    alert("Paiement effectué, vous pouvez retourner à la page d'acceuil");

    // On renvoie l'utilisateur sur la page d'accueil : index.php
